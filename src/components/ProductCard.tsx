    ...
    return (
        ...
        >
            ...
            <div className="p-3 sm:p-4 md:p-5 flex flex-col flex-1 relative z-10 bg-gradient-to-b from-transparent to-background/50">
                <h3
                    className="text-sm sm:text-base md:text-lg font-bold text-white mb-1.5 line-clamp-1 group-hover:text-primary transition-colors duration-300 cursor-pointer"
                    onClick={() => navigate(`/products/${product.slug}`)}
                >
                    {product.name}
                </h3>
                <p className="text-[10px] sm:text-xs md:text-sm text-white/60 line-clamp-2 mb-4 leading-relaxed flex-1">
